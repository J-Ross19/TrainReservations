...
Use TrainDatabase;
create table Train (id int primary key, num_seats int, num_cars int);
create table Station (id int primary key, name varchar(100), state varchar(5), city varchar(100));
...
create table Reservation_Portfolio (reservation_number int primary key, date_made datetime, booking_fee double, isMonthly boolean, isWeekly boolean, isRoundTrip boolean, username varchar(100) not NULL, foreign key(username) references Customer(username) on delete cascade);
